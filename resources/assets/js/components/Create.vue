<template>
  <div class="card card-body">
    ...
    <div class="row mt-3 mb-3 px-3">
      <button type="button" class="btn btn-primary" @click="createMedium" :data-kt-indicator="is_loading? 'on':'off'" :disabled="is_loading">
...
export default {
  ...
  methods:{
    async createMedium(){
      ...
      await axios.post(route('dashboard.media.store'), this.medium).then((res) => {
